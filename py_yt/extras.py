...
class Playlist:
    ...
    def __init__(self, playlistLink: str, proxy: Optional[str] = None):
    ...
    @staticmethod
    async def get(
        playlistLink: str, proxy: Optional[str] = None
    ) -> Union[dict, str, None]:
        """Fetches information and videos for the given playlist link.
        Returns None if playlist is unavailable.
...
class Transcript:
    @staticmethod
    async def get(videoLink: str, params: str = None, proxy: Optional[str] = None):
